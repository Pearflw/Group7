...
suggestBooks(bookDF, userDF, 2304, 10)
```
...
user_history <- ratings_full[ratings_full$user_id==2304 &ratings_full$rating>=4]
...
userForPrediction<-2001    #2001 for Catalina, 2002 for Yanhan
