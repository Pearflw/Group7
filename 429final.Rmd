...
temp2 <- within(books, original_publication_year <- factor(original_publication_year,levels=names(sort(table(original_publication_year), decreasing=TRUE))))
ggplot(temp,aes(x=original_publication_year))+geom_bar()
ggplot(data.frame(temp), aes(x=original_publication_year,fill=original_publication_year)) +
  geom_bar()+
  labs(x = "year", title = "Publication Year") +
  theme_pubclean()+ 
  theme(legend.position = "none")
hist(books$original_publication_year)

temp3 <- within(books, books_count <- factor(books_count,levels=names(sort(table(books_count), decreasing=TRUE))))
ggplot(temp,aes(x=books_count))+geom_bar()
ggplot(data.frame(temp), aes(x=books_count,fill=books_count)) +
  geom_bar()+
  labs(x = "books count", title = "Books Count") +
  theme_pubclean()+ 
  theme(legend.position = "none")
