...
set.seed(7)
e <- evaluationScheme(r, method="cross-validation",k=10, given=-5)
for (i in c(1,2,3,5,7,10,15,20,30)){
...
Algorithm <-list("UBCF_20"  = list(name="UBCF", param=list(nn = 20)),
                 ...
                 "SVDF"=list(name="SVDF", param=list(k=10,gamma=0.02,lambda=0.005,
                                                                  min_epochs=20,max_epochs=100,min_improvement=1e-05)))
...
r_recom_SVDF <- Recommender (r, method = "SVDF" , param=list(k=10,gamma=0.02,lambda=0.005,
                                                                  min_epochs=20,max_epochs=100,min_improvement=1e-05))
# do predictions
...
fsvd<- funkSVD(r, k = 10, gamma = 0.02, lambda = 0.005,
