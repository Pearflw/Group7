...
hist(books$original_publication_year, col = "#56B4E9", main = "Publication year", xlab = " ")
# book count, Number of book editions
hist(books$books_count, col = "#56B4E9", main = "Number of book editions", xlab = " ")
# Average Rating of books
hist(books$average_rating, col = "#56B4E9", main = "Average Rating", xlab = " ")
# Ratings distribution
hist(ratings$rating, col = "#56B4E9", main = " Ratings distribution", xlab = " ")
ratings_for_plot=ratings
# Number of books a user has rated
ratings_for_plot[, 'Number of books a user has rated' := .N, .(user_id)] 
hist(ratings_for_plot$'Number of books a user has rated', col = "#56B4E9", main = "Number of books a user has rated", xlab = " ")
# Number of ratings per book
ratings_for_plot[, 'Popularity(Number of ratings per book)' := .N, .(book_id)]
hist(ratings_for_plot$'Popularity(Number of ratings per book)', col = "#56B4E9", main = "Number of ratings per book", xlab = " ")
...
for (i in c(0.001,0.003,0.005,0.007,0.01)){
  ...
  Rec.SVDF <- Recommender(getData(e, "train"), "SVDF", 
                          param=list(k=10,gamma=0.05,lambda=i,
