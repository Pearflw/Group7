...
```{r}
#To eliminate running time, we sample the ratings dataset with 3,000 users
#And based on the rest ratings, we try to get a computationally feasible dataset
...
suggestBooks(bookDF, userDF, 40202, 10)
```
...
results_UBCF <- evaluate(scheme, method="UBCF",param=list(nn = 30)  , type = "topNList",  n=c(3,5,10,15,20))
